...
CREATE TABLE Salary_Backup (emp_id INT, old_salary DECIMAL(12,2),new_salary DECIMAL(12,2),salary_difference DECIMAL(12,2),changed_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP);
